...
def generate_job_description(title, industry="", responsibilities="", skills="", experience=""):
    ...
    base_prompt += "make the section headers to be blue with higher font size, headers like about , job summary , Responsibilities , font type arial , generate a normal text"
