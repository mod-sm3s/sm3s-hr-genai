...
def generate_job_description(title, industry="", responsibilities="", skills="", experience=""):
    ...
    base_prompt += "After any section title make a new line"
    base_prompt += "make font color of headers of sections to be blue, like About , Job Summary and Responsibilities  , do not return html elements , just normal text"
