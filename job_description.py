...
def generate_job_description(title, industry="", responsibilities="", skills="", experience=""):
    ...
    base_prompt += "make font color of sections headers like About , Job Summary and Responsibilities to be blue in the resulted text , do not generate html file , just normal file"
